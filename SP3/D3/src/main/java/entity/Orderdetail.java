...
public class Orderdetail implements Serializable {
    ...
    private ClassicOrder classicOrder;
    ...
    public ClassicOrder getClassicOrder() {
        return classicOrder;
    }

    public void setClassicOrder(ClassicOrder classicOrder) {
        this.classicOrder = classicOrder;
    }
